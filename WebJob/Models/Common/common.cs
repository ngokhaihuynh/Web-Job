...
namespace WebJob.Models.Common
{
    public class common
    {
        ...
        public static bool SendMail(string name, string Subject, string content, string toMail)
        {
            ...
            try
            {
                ...
                var smtp = new System.Net.Mail.SmtpClient();
                {
                    ...
                    smtp.Credentials = new NetworkCredential(Email, password); // Lấy thông tin từ cấu hình
                }
                ...
                message.IsBodyHtml = true; // Đảm bảo nội dung là HTML
