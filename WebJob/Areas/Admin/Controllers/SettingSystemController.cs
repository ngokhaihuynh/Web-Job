...
namespace WebJob.Areas.Admin.Controllers
{
    public class SettingSystemController : Controller
    {
        ...
        {
            Setting set = null;
            var checkTitle = db.Settings.FirstOrDefault(x => x.SettingKey.Contains("SettingTitle"));
            if (checkTitle == null)
            {
                set = new Setting();
            ...
            //logo
            var checkLogo = db.Settings.FirstOrDefault(x => x.SettingKey.Contains("SettingLogo"));
            if (checkLogo == null)
            {
                set = new Setting();
            ...
            //Email
            var email = db.Settings.FirstOrDefault(x => x.SettingKey.Contains("SettingEmail"));
            if (email == null)
            {
                set = new Setting();
            ...
            //Hotline
            var Hotline = db.Settings.FirstOrDefault(x => x.SettingKey.Contains("SettingHotline"));
            if (Hotline == null)
            {
                set = new Setting();
            ...
            //TitleSeo
            var TitleSeo = db.Settings.FirstOrDefault(x => x.SettingKey.Contains("SettingTitleSeo"));
            if (TitleSeo == null)
            {
                set = new Setting();
            ...
            //DessSeo
            var DessSeo = db.Settings.FirstOrDefault(x => x.SettingKey.Contains("SettingDesSeo"));
            if (DessSeo == null)
            {
                set = new Setting();
            ...
            //KeySeo
            var KeySeo = db.Settings.FirstOrDefault(x => x.SettingKey.Contains("SettingKeySeo"));
            if (KeySeo == null)
            {
                set = new Setting();
